...
<body class="bg-slate-950 font-sans text-slate-100 overflow-hidden select-none">
    ...
    <div class="fixed inset-0 z-0">
        <!-- Base image -->
        <img src="https://images.unsplash.com/photo-1542744173-8e7e53415bb0?q=80&w=2000&auto=format&fit=crop" class="w-full h-full object-cover scale-105 filter blur-sm opacity-40 mix-blend-luminosity animate-pulse-slow">
        <!-- Gradients over image -->
        <div class="absolute inset-0 bg-gradient-to-tr from-slate-950 via-emerald-950/80 to-violet-950/80"></div>
        <!-- Ambient Orbs -->
        <div class="absolute top-0 right-0 w-[50vw] h-[50vw] bg-emerald-500/20 rounded-full blur-[150px] translate-x-1/3 -translate-y-1/3 animate-float"></div>
        <div class="absolute bottom-0 left-0 w-[40vw] h-[40vw] bg-violet-500/20 rounded-full blur-[150px] -translate-x-1/3 translate-y-1/3 animate-float" style="animation-delay: 2s;"></div>
    </div>
    ...
    <div class="relative z-10 min-h-screen flex flex-col justify-between p-6 md:p-12">
        ...
        <!-- Center Auth Modal -->
        <div class="flex-1 flex items-center justify-center w-full my-12 animate-zoom-in">
            <div class="w-full max-w-md bg-white/10 dark:bg-slate-900/40 backdrop-blur-3xl p-10 md:p-12 rounded-[3rem] border border-white/20 shadow-[0_0_50px_rgba(0,0,0,0.5)] relative overflow-hidden group">
                <!-- Glossy highlight -->
                <div class="absolute top-0 left-1/2 -translate-x-1/2 w-3/4 h-px bg-gradient-to-r from-transparent via-white/40 to-transparent"></div>
                ...
                <form class="space-y-5" onsubmit="event.preventDefault(); window.location.href='user_dashboard.html';">
                    ...
                    <button class="w-full bg-emerald-500 text-white font-black text-lg py-4 rounded-2xl hover:bg-emerald-400 transition-all shadow-lg shadow-emerald-500/25 active:scale-95 mt-4 flex items-center justify-center gap-2 group animate-fade-in-up delay-300">
                        <span id="submit-text">Initiate Link</span>
                        <i data-lucide="arrow-right" class="w-5 h-5 group-hover:translate-x-1 transition-transform"></i>
                    </button>
                </form>

                <div class="mt-8 pt-6 border-t border-white/10 text-center animate-fade-in-up delay-400">
                    <p class="text-xs text-slate-500 font-medium">Alternative entry vectors</p>
                    <div class="flex justify-center gap-4 mt-4">
                        <button class="w-12 h-12 bg-white/5 hover:bg-white/10 rounded-full border border-white/10 flex items-center justify-center transition-all">
                        ...
                        <button class="w-12 h-12 bg-white/5 hover:bg-white/10 rounded-full border border-white/10 flex items-center justify-center text-white transition-all">
